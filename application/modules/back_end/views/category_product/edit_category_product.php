        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
							<form action="<?php echo base_url('back_end/category_product/update/'); ?>" method="post" enctype="multipart/form-data">
								...
								<div class="form-group row">
									<label class="col-sm-3 col-form-label">Preview</label>
									<div class="col-sm-9">
										<img id="previewImgCoverHome" src="./storage/uploads/images/products/<?php echo $category_product_img_cover_home ?>" style="background-color: #fff;" width="20%" onerror="this.onerror=null;this.src='data:image/png;base64,';">
									</div>
								</div>
								<div class="form-group row">
