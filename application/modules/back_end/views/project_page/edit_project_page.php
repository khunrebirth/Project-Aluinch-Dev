                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo base_url('backoffice/page/project/content/update/1'); ?>" method="post" enctype="multipart/form-data">
