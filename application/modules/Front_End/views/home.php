    <!-- Push Style -->
    <link rel="stylesheet" href="<?php echo base_url('resources/front-end/css/owl.carousel.css'); ?>">
    ...
    <!-- Push Scripts -->
    <script src="<?php echo base_url('resources/front-end/js/owl.carousel.min.js'); ?>"></script>
    <script src="<?php echo base_url('resources/front-end/js/scrollIt.js?v=1001'); ?>"></script>
    <script src="<?php echo base_url('resources/front-end/js/main-home.js'); ?>"></script>
    <script src="<?php echo base_url('resources/front-end/js/skrollr.min.js'); ?>"></script>
