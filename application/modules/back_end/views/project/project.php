                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="<?php echo base_url('backoffice/page/project/projects/create'); ?>"
                                                    ...
                                                    <div class="dropdown d-inline">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item has-icon"
                                                               href="<?php echo base_url('backoffice/page/project/projects/edit/' . $project->id); ?>"><i
                                                                        class="far fa-edit"></i> Edit</a>
                                                            <a class="dropdown-item has-icon"
                                                               onclick="deleteGroupProject('<?php echo base_url('backoffice/page/project/projects/destroy/' . $project->id); ?>')"><i
