    ...
    <div class="bg-orange">
        <div class="warp">
            <div class="box-contact box-contact-1">
                ...
                <div class="clearfix"></div>
                <div class="copy desktop float-none">Copyright © 2020 www.aluinch.com All Rights Reserved. SEO maintained by iSEO.in.th</div>
                <div class="copy-line desktop"></div>
                <div class="list-social">
                    <a href="http://line.me/ti/p/~ALUMINATION" target="_blank">
                        <img class="icon-line" src="<?php echo base_url('storage/images/line-icon.png'); ?>" />
                    </a>&nbsp;
                    <a href="https://www.facebook.com/ALUINCH/" target="_blank">
                        <img class="icon-fb" src="<?php echo base_url('storage/images/fb2.png'); ?>" />
                    </a>
                </div>
            </div>
            <div class="box-contact form-contact">
                ...
                <div class="copy mobile">Copyright © 2020 www.aluinch.com All Rights Reserved. SEO maintained by iSEO.in.th</div>
                <div class="clearfix"></div>
