            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url('backoffice/page/technology/category/update/' . $technologies->id); ?>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <img id="previewMetaOgImg"
                                             src="<?php echo base_url('storage/uploads/images/technologies/' . $technologies->img_og_twitter); ?>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="title"
                                               value="<?php echo $technologies->title ?>" required>
                                    </div>
                                </div>
                                <div class="text-right">
                                    ...
                                    <a href="<?php echo base_url('backoffice/page/technology/category'); ?> "
