            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url('backoffice/page/home/gallery/update/'.$image_galleries->id); ?>" method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <img id="previewImgCover" src="<?php echo base_url('storage/uploads/images/portfolios/'. $image_galleries->title );?>" style="background-color: #fff;" width="20%"
                                    ...
                                    <div class="col-sm-9">
                                        <div class="custom-file input-file-w-30">
                                            <input type="file" class="custom-file-input" name="img_cover"
                                                   onchange="PreviewImage(this, 'previewImgCover');" value="<?php echo $image_galleries->title; ?>" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="img_title_alt" value="<?php echo $image_galleries->img_title_alt; ?>">
                                    </div>
                                </div>
                                <div class="text-right">
                                    <button type="submit" class="btn btn-primary">Save changes</button>
                                    <a href="<?php echo base_url('backoffice/page/home/gallery'); ?>" class="btn btn-secondary">Close</a>
                                </div>
                            </form>
                        </div>
                    </div>
