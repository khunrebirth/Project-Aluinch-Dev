                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url('backoffice/page/technology/technology_videos/update/' . $technology_videos->id); ?>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="meta_tag_title" value="<?php echo $technology_videos->meta_tag_title; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Description</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="meta_tag_description" value="<?php echo $technology_videos->meta_tag_description; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Keywords</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="meta_tag_keywords" value="<?php echo $technology_videos->meta_tag_keywords; ?>">
                                    </div>
                                </div>
                                <!-- OG & Twitter -->
