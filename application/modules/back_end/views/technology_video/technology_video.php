                                                ...
                                                <div class="dropdown d-inline">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item has-icon"
                                                           href="<?php echo base_url('backoffice/page/technology/technology_videos/edit/' . $technology_video->id); ?>"><i
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dropdown d-inline">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item has-icon"
                                                               href="<?php echo base_url('backoffice/page/technology/technology_videos/edit/' . $feq_technology->id); ?>"><i
                                                                        class="far fa-edit"></i> Edit</a>
                                                            <a class="dropdown-item has-icon"
