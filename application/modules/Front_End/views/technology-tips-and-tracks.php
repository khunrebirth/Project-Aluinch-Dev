    ...
    <section id="technology" class="main-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3">
                    <ul class="list-item">
                        <li><a href="<?php echo base_url('technology'); ?>">PRESENTATION VDO วีดีโอแนะนำการใช้งาน</a></li>
                        <li class="active"><a href="<?php echo base_url('technology-tips-and-tracks'); ?>">TIPS AND TRICKS  เกร็ดความรู้อลูมิเนียม</a></li>
