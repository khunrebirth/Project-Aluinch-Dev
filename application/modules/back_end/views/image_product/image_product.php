...
<script>
    ...
    $(document).ready(function() {
        $('#btnSort').on('click', function() {
            ...
            $.ajax({
                type: "POST",
                url: window.base_url + 'backoffice/page/product/list-product-pictures/ajax/get/product/sort/show/' + productId,
                success: function(res) {
        ...
        $('#btnSaveSorting').click(function() {
            ...
            $.ajax({
                type: "POST",
                url: window.base_url + 'backoffice/page/product/list-product-pictures/ajax/get/product/sort/update/' + productId,
                data: {
                    id: selectedID,
                    sort: selectedSort
                },
