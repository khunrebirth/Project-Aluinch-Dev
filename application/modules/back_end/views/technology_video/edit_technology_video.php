        ...
        <div class="section-header">
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item "><a
                            href="<?php echo base_url('backoffice/page/technology/technology_videos/show/' . $category_technology->id); ?>">Technology</a>
                </div>
                <div class="breadcrumb-item active ">Edit Technology:
                    (Category-<?php echo $category_technology->title; ?>)
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url('backoffice/page/technology/technology_videos/update/' . $technology_videos->id); ?>"
                                  method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="meta_tag_title"
                                               value="<?php echo $technology_videos->meta_tag_title; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="meta_tag_description"
                                               value="<?php echo $technology_videos->meta_tag_description; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="meta_tag_keywords"
                                               value="<?php echo $technology_videos->meta_tag_keywords; ?>">
                                    </div>
                                </div>
                                <!-- OG & Twitter -->
                                <div style="padding-top: 20px;"><h6><i class="fa fa-tag"></i> Image OG &amp; Twitter
                                    </h6></div>
                                <hr>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <img id="previewMetaOgImg"
                                             src="<?php echo base_url('storage/uploads/images/technologies/' . $technology_videos->img_og_twitter); ?>"
                                             style="background-color: #fff;" width="18%"
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label"><span class="text-danger">*</span> File
                                        Upload</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="title"
                                               value="<?php echo $technology_videos->title; ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" class="summernote"
                                                  name="body"><?php echo $technology_videos->body; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Description</label>
                                    <div class="col-sm-9">
                                        <textarea type="text" class="form-control"
                                                  name="description"><?php echo $technology_videos->description; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" class="form-control" name="src"
                                                  required><?php echo $technology_videos->src; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">* Short Src</label>
                                    <div class="col-sm-9">
                                        <textarea type="text" class="form-control" name="short_src"
                                                  required><?php echo $technology_videos->short_src; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Preview</label>
                                    <div class="col-sm-9">
                                        <img id="previewImgCover" src="<?php echo $technology_videos->img_cover; ?>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="img_cover"
                                               value="<?php echo $technology_videos->img_cover; ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="img_title_alt"
                                               value="<?php echo $technology_videos->img_title_alt; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
