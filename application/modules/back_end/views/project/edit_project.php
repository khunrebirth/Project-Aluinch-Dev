    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="<?php echo base_url('backoffice/page/project'); ?>">Project</a></div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url('back_end/Project/update/'.$projects->id); ?>" method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="title" value="<?php echo $projects->title; ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Description</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="description" value="<?php echo $projects->description; ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Preview</label>
                                    <div class="col-sm-9">
                                        <img id="previewImgCover" src="<?php echo base_url('storage/uploads/images/projects/'. $projects->img_cover )?> " style="background-color: #fff;" width="20%"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="img_title_alt" value="<?php echo $projects->img_title_alt; ?>">
                                    </div>
                                </div>
                                <div class="text-right">
                                    <button type="submit" class="btn btn-primary">Save changes</button>
                                    <a href="<?php echo base_url('backoffice/page/project')?>" class="btn btn-secondary">Close</a>
                                </div>
                            </form>
                        </div>
                    </div>
