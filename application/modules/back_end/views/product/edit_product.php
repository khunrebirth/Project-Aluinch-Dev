    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-breadcrumb">
				...
				<div class="breadcrumb-item"><a href="<?php echo base_url('backoffice/page/product/product/show/' . $products->group_product_id .'/'.$products->category_product_id); ?>">Product : (Categories - <?php echo $category_products->title; ?>)</a></div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
							<form action="<?php echo base_url('back_end/product/update/'.$products->id); ?>" method="post" enctype="multipart/form-data">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" name="title" value="<?php echo $products->title;?>" required>
									</div>
								</div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">* Description (TH)</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="description_th" value="<?php echo $products->description_th;?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">* Description (EN)</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="description_en" value="<?php echo $products->description_en;?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">* Detail</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="detail" value="<?php echo $products->detail;?>" required>
                                    </div>
                                </div>
								<div class="form-group row">
									...
									<div class="col-sm-9">
										...
										<input type="text" class="form-control"  value="<?php echo $group_products->title; ?>" disabled="disabled">
									</div>
								</div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Category</label>
                                    <div class="col-sm-9">
                                        <input type="hidden"  value="<?php echo $category_products->id; ?>" name="category_product_id">
                                        <input type="text" class="form-control"  value="<?php echo $category_products->title; ?>" disabled="disabled">
                                    </div>
                                </div>
<!--								<div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-sm-3 col-form-label">Preview</label>
									<div class="col-sm-9">
										<img id="previewImgCoverHome" src="" style="background-color: #fff;" width="20%" onerror="this.onerror=null;this.src='data:image/png;base64,';">
									</div>
								</div>
								<div class="form-group row">
