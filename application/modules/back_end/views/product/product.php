                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="<?php echo base_url('backoffice/page/product/products/create/' . $group_products->id . '/' . $category_products->id); ?>"
                                                ...
                                                <div class="dropdown d-inline">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item has-icon"
                                                           href="<?php echo base_url('backoffice/page/product/products/edit/' . $product->id); ?>"><i
                                                                    class="far fa-edit"></i> Edit</a>
                                                        <a class="dropdown-item has-icon"
                                                           onclick="deleteProduct('<?php echo base_url('backoffice/page/product/products/destroy/' . $product->id); ?>')"><i
