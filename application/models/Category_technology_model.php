...
//        ";
		...
		$sql = "
			SELECT *,
			(SELECT COUNT(*) FROM technology_videos WHERE category_technologies.id = technology_videos.category_technology_id) as counter
			FROM category_technologies
			WHERE category_technologies.id = $category_technology_id
		";
...
//        ";
		...
		$sql = "
			SELECT *,
			(SELECT COUNT(*) FROM faq_technologies WHERE category_technologies.id = faq_technologies.category_technology_id) as counter
			FROM category_technologies
			WHERE category_technologies.id = $category_technology_id
		";
