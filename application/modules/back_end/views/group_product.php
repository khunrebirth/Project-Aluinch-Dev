                                                ...
                                                <td>
                                                    <div class="dropdown d-inline">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item has-icon" onclick="editGroupProduct('<?php echo base_url('backoffice/page/product/group/edit/' . $group_product->id); ?>')"><i class="far fa-edit"></i> Edit</a>
