    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">Image Project (<?php echo $project->title; ?>)</div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>List of Image Project (<?php echo $project->title; ?>)</h4>
                            <div class="card-header-action">
								<button class="btn btn-primary" id="btnSort"><i class="fas fa-sort"></i> Sort Images</button>
                                <a href="<?php echo base_url('backoffice/page/project/list-project-pictures/create/' . $project->id); ?>" class="btn btn-primary" >
                                    ...
                                    <?php
                                        ...
                                        foreach ($project_pictures as $project_picture) { ?>
                                            <tr>
                                                ...
                                                <td><img id="previewImgCover"  src="<?php echo base_url('storage/uploads/images/projects/'. $project_picture->title );?>" style="background-color: #fff;" width="20%"></td>
                                                <td><?php echo $project_picture->created_at; ?></td>
                                                <td>
                                                    <div class="dropdown d-inline">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item has-icon" href="<?php echo base_url('backoffice/page/project/list-project-pictures/edit/' . $project->id . '/' . $project_picture->id); ?>" ><i class="far fa-edit"></i> Edit</a>
                                                            <a class="dropdown-item has-icon" onclick="deleteImageProduct('<?php echo base_url('backoffice/page/project/list-project-pictures/destroy/' . $project_picture->id); ?>')"><i class="far fa-trash-alt"></i> Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
...
<script>
    ...
    $(document).ready(function() {
        $('#btnSort').on('click', function() {
            let projectId = "<?php echo $project->id; ?>"
            $.ajax({
                type: "POST",
                url: window.base_url + 'backoffice/page/project/list-project-pictures/ajax/get/project/sort/show/' + projectId,
                success: function(res) {
        ...
        $('#btnSaveSorting').click(function() {
            ...
            $.ajax({
                type: "POST",
                url: window.base_url + 'backoffice/page/project/list-project-pictures/ajax/get/project/sort/update/' + projectId,
                data: {
                    id: selectedID,
					sort: selectedSort
				},
